...
def hard_restore():
    ...
    slots_data = [
      {
        'basket_id': 17, 
        'entry_time': '2026-06-19T09:15:00+05:30', 
        'entry_type': 'ema_crossover', 
        'tickers': ['UNIONBANK.NS', 'LAURUSLABS.NS', 'PIDILITIND.NS', 'BDL.NS', 'LODHA.NS', 'BAJAJ-AUTO.NS'], 
        'quantities': {'UNIONBANK.NS': 4732, 'LAURUSLABS.NS': 609, 'PIDILITIND.NS': 530, 'BDL.NS': 636, 'LODHA.NS': 903, 'BAJAJ-AUTO.NS': 82}, 
        'entry_prices': {'UNIONBANK.NS': 176.1, 'LAURUSLABS.NS': 1368.0, 'PIDILITIND.NS': 1572.0, 'BDL.NS': 1309.3, 'LODHA.NS': 922.65, 'BAJAJ-AUTO.NS': 10134.0}, 
        'investment': 4996433.0, 
        'capital_allocated': 5000000.0, 
        'entry_basket_close': 46390919.35510254, 
        'peak_basket_close': 46390919.35510254, 
        'returns_ref_value': 4996433.0, 
        'returns_ref_time': '2026-06-19T09:15:00+05:30'
      }, 
      {
        'basket_id': 7, 
    ...
    conn.commit()
    conn.close()
    print("State 100% recovered successfully using local workspace cache!")
